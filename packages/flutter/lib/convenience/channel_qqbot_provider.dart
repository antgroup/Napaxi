...
class QqBotChannelProvider implements NapaxiChannelProvider {
  ...
  static const _gatewayReadyEventType = 'READY';
  ...
  Future<void> _connectGatewayWithMode({required bool resume}) async {
    ...
    try {
      ...
      if (!_connected) {
        ...
        _lastError = 'QQBot Gateway $_gatewayReadyEventType timeout after '
  ...
  /// heartbeat seq, READY/RESUMED, invalid_session reconnect classification, inbound
