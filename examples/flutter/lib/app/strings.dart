...
class AppStrings {
  const AppStrings({
    ...
    required this.terminalSessionPreview,
  ...
  final String terminalSessionPreview;
  ...
  static final english = AppStrings(
    ...
    terminalSessionPreview: 'Interactive workspace shell',
  ...
  static final chinese = AppStrings(
    ...
    terminalTitle: '终端',
    terminalSessionPreview: '交互式工作区 Shell',
