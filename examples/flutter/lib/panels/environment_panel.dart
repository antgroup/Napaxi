...
name: android-project-template
description: Create Git-managed Android application projects in the mobile development scenario. Use when the user asks to develop an Android app, APK, tool, demo, interactive mobile experience, or a supported WebView/local HTML wrapper app.
keywords:
  - android
  - apk
  - app
...
- Create a real Android project that builds to an APK. If the user asks for web,
  H5, HTML, or frontend-style output, implement it as an Android WebView/local
  assets wrapper when the available tools support that path.
